...
- 기업부스, 모두콘에 참여한 다른 참여자들과의 네트워킹을 다질 수 있는 기회였습니다.
...
- GPT4와 구글 바드의 성능 차이는 크고, 재미나이 프로는 외국어 능력이 아쉬운 부분이 있으며 한국어 테스트에서도 아쉬운 부분이 있다고 한다.
