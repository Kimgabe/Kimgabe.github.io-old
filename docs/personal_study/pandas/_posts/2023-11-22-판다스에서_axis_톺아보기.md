---
layout: single
title: "[Pandas] 판다스의 axis 옵션 톺아보기 - 연산방향? 연산대상? 예제코드로 알아봅시다!! 🤓"
categories:
  - pandas
tags:
  - axis
...
---
## 🚦 Summary
- 판다스에서 쓰이는 axis 옵션은 데이터프레임에 대한 연산방향에 대한 옵션입니다.
...
> 1. axis = 'index' 에서 'index'는 연산할 값을 의미합니다.
...
![](https://i.imgur.com/O1jNELG.png)

  
  

- 전체의 DataFrame이라고 보는게 헷갈린다면 특정 컬럼하나를 지정해서 보면 조금 더 이해가 쉬울 수 있습니다.
...
> 1. axis = 'column' 에서 'column'은 연산할 값을 의미합니다.
